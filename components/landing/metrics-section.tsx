...
const metrics = [
  { 
    ...
    sublabel: "organic, first 2 weeks",
  },
  { 
    value: 68, 
    suffix: "%", 
    ...
    sublabel: "30-day closed beta",
  },
  { 
    value: 42, 
    suffix: "%", 
    prefix: "",
    label: "14+ day streaks",
    sublabel: "maintained in pilot cohort",
  },
];
...
export function MetricsSection() {
  ...
  return (
    <section id="traction" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      <GridBackground />
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>500+ waitlist signups</span>
          <span>78% quiz completion</span>
          <span>320 builders submitted project proof</span>
          <span>12 mentors committed</span>
          <span className="text-foreground">4 accelerator discussions active</span>
        </div>
      </div>
    </section>
  );
